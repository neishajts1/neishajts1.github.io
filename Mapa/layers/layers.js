...
lyr_CuencaRioGuey_1.set('fieldLabels', {'Area': 'inline label - always visible', });
lyr_DepartamentoseInstitutos_2.set('fieldLabels', {'photo': 'inline label - always visible', 'altitude': 'inline label - always visible', 'longitude': 'inline label - always visible', 'latitude': 'inline label - always visible', 'Nombre': 'inline label - always visible', 'Numero': 'inline label - always visible', });
